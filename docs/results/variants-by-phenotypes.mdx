...
The report includes ***conditions*** ([ClinVar](https://preview.ncbi.nlm.nih.gov/clinvar/) phenotypes) that have
...
ClinVar phenotypes report can be downloaded in PDF format.
