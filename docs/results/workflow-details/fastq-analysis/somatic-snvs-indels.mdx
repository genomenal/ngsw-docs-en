...
Not included in the analysis if filtering is disabled
in [the parameters](/settings/settings/variant-discovery-settings#filter-strand-orientation-bias)
(recommended when analyzing amplicon panels).
