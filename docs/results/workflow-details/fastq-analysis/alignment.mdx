...
variations discovery, as well as genomic predictions) requires alignment (mapping) of reads to the reference
...
(can be changed in the [parameters](/settings/settings/alignment-settings#alignment-metrics)), are provided;
...
<table>
  <tr>
   ...
   can be changed in <a href="/settings/settings/alignment-settings#alignment-metrics">parameters</a>)</td>
  </tr>
  <tr>
...
alignments as described [here](/settings/settings/alignment-settings#bwa-mem-parameters).
:::
