...
SNVs/Indels discovery, structural variations discovery, copy number variations discovery,
or at least one of the genomic predictions tasks (oligogenic/polygenic risk scores calculation, pharmacogenetic
...
10. [Genomic predictions](/results/workflow-details/fastq-analysis/phenotypes)
if [oligogenic risk scores calculation](/settings/settings/variant-discovery-settings#enable-phenotype-prediction),
[polygenic risk scores calculation](/settings/settings/variant-discovery-settings#polygenic-risk-scores-calculation),
pharmacogenetic calculation and/or ancestry analysis are included in the workflow;
