...
from [the "Genomic predictions" section](/settings/settings/variant-discovery-settings#phenotype-prediction).
...
3. [Genomic predictions](/results/workflow-details/vcf-analysis/phenotypes)
