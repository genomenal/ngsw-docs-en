...
If the sample analysis workflow includes oligogenic/polygenic risk scores calculation, pharmacogenetic calculation
and/or ancestry analysis,
then [the "Genomic predictions" stage](/results/workflow-details/vcf-analysis/phenotypes) will be launched in
