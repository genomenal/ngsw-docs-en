...
- SEQUENCING TYPE: Panel (sequencing using a targeted panel), WES (whole-exome sequencing), Low-pass WGS (whole-genome
sequencing), WGS, UNKNOWN. Determined automatically by Genomenal, can be based on the sequencing type that was selected
while adding sample set. Can be changed on [the Parameters tab](/results/parameters).
