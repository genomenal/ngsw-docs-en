...
The needed copy number variations can be found by filtering. Filtering options are at the top of the table:
...
<p align="center">
<img src={require('/img/vv/log2fc_value.png').default} width="250"/>
</p>
...
Filter variations by the copy number variation type: Del - deletion, Dup - duplication.

### 7. Cohort 180 AF {#cohort-af}

Filter variations by frequency in a cohort of 188 samples. Frequency values are only available for bins of
size 3000 or 5000. The filter is only displayed in the CNV Viewer with copy number variations discovered in the bins.
