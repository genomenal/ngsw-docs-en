...
- The columns:
    ...
    11. **Conservation: [CS] confidence value**: filtering by confidence value of various conservative
    scores: Highly significant; Significant; Informative; Other,
    where **[CS]** is a conservation score: Integrated, GM12878, H1-hESC, HUVEC.
    12. **Protein function effect: [PA] prediction**: filtering by the results of predicting
    ...
    14. **Trio GT (Genotype)**: filtering by variant inheritance: *De novo* variants, Newly formed
