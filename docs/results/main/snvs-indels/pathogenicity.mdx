...
in "Pathogenicity" column in Variant Viewer. If the pathogenicity was not determined, then the column value
...
## Determined variant pathogenicity in Variant Viewer {#defined-pathogenicity-in-vv}
...
- Likely pathogenicity variant: <img src={require('/img/vv/probably_pathogenic.png').default} width="40"/>
...
On Variant Viewer page, variants that require pathogenicity confirmation are
