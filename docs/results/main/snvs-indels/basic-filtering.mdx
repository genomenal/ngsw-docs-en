...
mode you will see when you first open the sample Variant Viewer page: Basic
...
of [Variant Viewer with germline mutations](/results/main/snvs-indels/variant-viewer).
:::
...
detail in <a href="/settings/gene-panels">the corresponding section</a>, or you can import panels from
the Library of the most common clinical panels. To import, click on "<i>Import from Library</i>":
...
- Filtering by gene transcript (shown in brackets). You can filter variants
...
- Filtering by terms from <a href="https://hpo.jax.org/app/">Human Phenotype Ontology (HPO)</a>.
