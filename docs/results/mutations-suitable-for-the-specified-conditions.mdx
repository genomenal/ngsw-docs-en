...
report template. Drawing up conditions for variants is
...
specified in
the ["CNVs suitable for the specified conditions"](/settings/report-templates/report-templates#suitable-cnvs) report
