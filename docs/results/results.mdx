...
3. **[Coverage Analysis](/results/coverage-analysis)** - contains information on depth of coverage
and coverage of genes and transcripts in a sample. The tab is displayed only for samples uploaded in FASTQ or
BAM format if [the "Calculate coverage" stage](/results/workflow-details/fastq-analysis/calculate-coverage) has
