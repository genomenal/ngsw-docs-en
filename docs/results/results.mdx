...
[the following reports may be active](/settings/report-templates/main_templates) for you (the addition of these
...
4. **[Workflow details](/results/workflow_details/workflow-details)** includes detailed information about the
