...
the system, click on <img src={require('/img/eng/add_patient_btn.png').default} width="170"/> on
the "All Patients" or "Samples" page. You will see the add patient window:
...
1. **Sample file names** (with extension) and **sample file size**. If the sample file is still being uploaded,
this will be reflected in the size information. For example, it will say "18 B of 240 KB". Tumor sample file is
...
class discovered in the sample
and <a href="/results/main/snvs-indels/variant-viewer#include-to-report">included to report</a> (Pathogenic: <img src={require('/img/results/pathogenic.png').default} width="48"/>,
...
4. **The last completed analysis stage status** or the status of the stage currently being
in progress:<br></br><img src={require('/img/eng/in_process_status.png').default} width="22"/> - the stage is
currently in progress;<br></br><img src={require('/img/eng/queed_status.png').default} width="14"/> - the stage is
queued or waiting for the prerequisite stages of the control sample to be completed (in the case of a
tumor sample from a pair of
tumor/normal samples);<br></br><img src={require('/img/eng/success.png').default} width="21"/> - the stage was
completed successfully,<br></br><img src={require('/img/eng/problems_status.png').default} width="25"/> - the stage
was completed successfully, but not all quality metrics meet the
criteria,<br></br><img src={require('/img/eng/failed_status.png').default} width="21"/> - the stage was failed.
5. **Sample analysis progress tiles**. Each tile is an analysis stage.
Blue tiles <img src={require('/img/eng/blue_in_progress.png').default} width="25"/> represent stages in progress or
queued or waiting for the prerequisite stages of the control sample to be completed (in the case of a tumor sample
from a pair of tumor/normal samples);
green <img src={require('/img/eng/green.png').default} width="25"/> - successfully completed stages;
orange <img src={require('/img/eng/orange.png').default} width="25"/> - stages completed successfully with
non-critical problems; red <img src={require('/img/eng/red.png').default} width="25"/> - failed stages;
...
- The analysis progress tiles of the sample in FASTQ
...
- LAST NAME, FIRST NAME, MIDDLE NAME of the patient. Can be specified by clicking on the value fields.
