...
class found in the sample and added to the report
...
added to the report, then the interpretation summary will be "*Interpretation not completed*". If the
sample interpretation has been completed, but no variants with a particular pathogenicity class have been
added to the report, then the interpretation summary will be "*No pathogenic variants found*".
...
- PROVIDED DIAGNOSIS is the patient's diagnosis at the moment of obtaining the sequencing sample.
