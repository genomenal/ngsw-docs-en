...
### 33. Oligogenic traits {#oligogenic-traits}
...
1. *Name* – the section title (required).
2. *Description* – the text displayed below the title.
3. *Probability threshold for populations* - the minimum threshold for the membership probability obtained
