...
[the "Pathogenicity" column in the Variant Viewer](/results/main/snvs-indels/variant-viewer#columns-description).
...
[the "External links" column in the Variant Viewer](/results/main/snvs-indels/variant-viewer#columns-description): <img src={require('/img/vv/cosmic.png').default} width="35"/>.
...
[on the Variant Viewer page](/results/main/snvs-indels/snv-details-panel#custom-annotation-sources-tab)
