...
In addition, you can add annotations containing data on the pathogenicity of variants,
and an annotation from the COSMIC database.
...
Specify annotation source reference genome (hg19 or hg38) for proper variant identification:
...
### 2. Defining the type of a custom annotation
...
[the "Pathogenicity" column in the Variant Viewer](/results/main/snvs_indels/variant-viewer#description-of-table-columns).
...
[the "External links" column in the Variant Viewer](/results/main/snvs_indels/variant-viewer#description-of-table-columns): <img src={require('/img/vv/cosmic.png').default} width="35"/>.
...
3. **An annotation with any other information about the variant** - in this case,
the annotation type does not need to be defined.
...
- a column with the pathogenicity class of the variants (make sure the correct column is selected with auto-detection):

<p align="center">
<img src={require('/img/custom-annot/pathogenicity_column.png').default} width="300"/>
</p>

If you have defined an annotation as ***a COSMIC database***, then you need to define a column with variant ID
from the [COSMIC](https://cancer.sanger.ac.uk/cosmic/) database (COSV\*\*\*\*\*\*\*\*\) (make sure the correct
column is selected with auto-detection):

<p align="center">
<img src={require('/img/custom-annot/id.png').default} width="300"/>
</p>

### 4. Adding an annotation column
...
or adding at least one annotation column for annotations other than pathogenicity or COSMIC databases),
...
[on the Variant Viewer page](/results/main/snvs_indels/snv_details_panel#custom-annotation-sources)
and in the file with variants, which can be downloaded from the main page of the sample.

## Editing a Custom Annotation
...
<p align="center">
<img src={require('/img/eng/apply_annot_changing.png').default} width="400"/>
</p>

- If you want to stop defining an already prepared annotation as a pathogenicity or COSMIC database,
